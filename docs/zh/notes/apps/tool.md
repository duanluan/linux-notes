...
`nc`（netcat）可以用于检查 TCP/UDP 服务、临时收发文本、排查本机或远程网络服务。
...
Keyviz 是一款免费开源的按键可视化软件，可以实时显示您的按键和鼠标操作！
...
SMPlayer 是个适用于 Windows 和 Linux 的免费媒体播放器，内置解码器，可以播放几乎所有格式的视频和音频文件。

![](https://www.smplayer.info/images/carousel/smplayer_skin_modern3.jpg)

[SMPlayer - 适用于 Windows 和 Linux 的免费多媒体播放器 - 官方网站](https://www.smplayer.info/zh/info)
